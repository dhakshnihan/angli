                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <h2 class="card-title card-heading">Agents</h2>
                                <div class="card-tools">
                                    <button type="button" class="btn main-btn" data-toggle="modal" data-target="#addagents">Add Agents</button>

                                    <div class="modal fade" id="addagents" tabindex="-1" aria-labelledby="addagentsLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <h5 class="text-center mb-3">ADD AGENTS</h5>
                                                ...
                                                <div class="agent-box">
                                                    <div class="d-flex justify-content-around">
                                                        <span class="info-box-icon">
                                                            <img src="./dist/img/AdminLTELogo.png" alt="" class="img-fluid agent-img">
                                                        </span>
                                                        <div class="d-flex justify-content-between">
                                                            <div class="">
                                                                <div class="info-box-content">
                                                                    <span class="info-box-text"><strong>Ravi Sanker</strong></span>
                                                                    <span class="location">Visakhapatnam</span>
                                                                    <span class="mob">Moble: 123 456 7890</span>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex justify-content-between">
                                                                <button class="agent-btn"><span class="added">21</span><br>Added</button>
                                                                <button class="agent-btn"><span class="visited">05</span><br>Visited</button>
                                                                <button class="agent-btn"><span class="completed">13</span><br>Completed</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="d-flex justify-content-around">
                                                        <div>
                                                            <button class="process def-btn">Processing</button>
                                                        </div>
                                                        <div>
                                                            <button class="ct-btn"><span class="hold"><i class="ion-ios-stopwatch-outline"></i></span><br>Hold</button>
                                                            <button class="ct-btn"><span class="cancel"><i class="ion-ios-stopwatch-outline"></i></span><br>cancel</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
